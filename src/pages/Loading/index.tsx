        ...
        <Body>
            ...
            <div className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
                ...
                <main className="px-3">
                    ...
                    <h4><p className="lead">If you succeed in loading the page, you can go to the original
                        page, <br></br> but if it fails, you can go to the main page.</p></h4>

                    {loading &&
                        <p className="lead">
                            <a href={targetUrl} className="btn btn-lg btn-secondary fw-bold border-white bg-gray">Turn
                                the page</a>
                        </p>
